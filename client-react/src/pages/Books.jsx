...
import { sampleBooks, readingStats } from '../data/books'
                  ...
                  <div className="card-body d-flex flex-column p-3">
                    ...
                    <div className="mt-auto">
                      <div className="progress mb-1" style={{ height: 5 }}>
                        <div className={`progress-bar ${PROGRESS_COLOR(book.progress)}`}
                          style={{ width: `${book.progress}%` }} role="progressbar"
                          aria-valuenow={book.progress} aria-valuemin="0" aria-valuemax="100" />
                      </div>
                      <small className="text-muted">{book.progress}% complete</small>
                    </div>
